    ...
    <section className="w-full max-w-full min-w-0 border-b border-[#E6E0D4]/40 pb-3 sm:pb-4">
      ...
      <div className="grid w-full min-w-0 grid-cols-3 gap-1 sm:gap-2 md:gap-3">
        <div className="min-w-0 space-y-0.5 sm:space-y-1">
          <label className="flex min-w-0 items-center gap-0.5 text-[9px] font-semibold leading-tight text-[#1F3A2B] sm:gap-1 sm:text-[10px] md:text-xs">
            <Globe className="h-2.5 w-2.5 shrink-0 text-[#2E6B8E] sm:h-3 sm:w-3 md:h-3.5 md:w-3.5" strokeWidth={2} aria-hidden />
            <span className="truncate">Cuisine</span>
          </label>
          <Select value={cuisine} onValueChange={onCuisineChange}>
            <SelectTrigger className="h-9 w-full min-w-0 max-w-full rounded-xl border border-[#E6E0D4]/90 bg-white px-1.5 text-[11px] text-[#1F3A2B] shadow-[0_2px_10px_-4px_rgba(47,74,22,0.08)] transition-all duration-200 hover:scale-[1.01] hover:shadow-[0_4px_14px_-4px_rgba(47,74,22,0.1)] sm:h-10 sm:px-2.5 sm:text-sm md:h-11 md:px-3">
        ...
        <div className="min-w-0 space-y-0.5 sm:space-y-1">
          <label className="flex min-w-0 items-center gap-0.5 text-[9px] font-semibold leading-tight text-[#1F3A2B] sm:gap-1 sm:text-[10px] md:text-xs">
            <Clock className="h-2.5 w-2.5 shrink-0 text-[#C45C1A] sm:h-3 sm:w-3 md:h-3.5 md:w-3.5" strokeWidth={2} aria-hidden />
        ...
        <div className="min-w-0 space-y-0.5 sm:space-y-1">
          <label className="flex min-w-0 items-center gap-0.5 text-[9px] font-semibold leading-tight text-[#1F3A2B] sm:gap-1 sm:text-[10px] md:text-xs">
            <ChefHat className="h-2.5 w-2.5 shrink-0 text-[#5A7F2E] sm:h-3 sm:w-3 md:h-3.5 md:w-3.5" strokeWidth={2} aria-hidden />
